...
| **Nguyễn Huyền Trang** |Data Cleaner / Data Analysist |Finding data, Write file `1.Data_Cleaning_and_Preprocessing.ipynb`, Support write description and insight for charts in file `2.EDA.ipynb`, Edit file Readme. |
